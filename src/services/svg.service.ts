const SVGS: Record<string, string> = {
  arrowDown: `<svg width="10" height="7" xmlns="http://www.w3.org/2000/svg"><path d="M1 1l4 4 4-4"  stroke-width="2" fill="none" fill-rule="evenodd"/></svg>`,
...
<path d="M0 0h20v3H0zM0 7h20v3H0zM0 14h20v3H0z"/></g></svg>`,
  ...
  check: `<svg xmlns="http://www.w3.org/2000/svg" width="13" height="11"><path fill="none" stroke="#AD1FEA" stroke-width="2" d="M1 5.233L4.522 9 12 1"/></svg>`,
}
